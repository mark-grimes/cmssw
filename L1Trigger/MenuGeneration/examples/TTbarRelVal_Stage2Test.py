...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/relval/CMSSW_7_4_0_pre2/RelValTTbar_13/GEN-SIM-DIGI-RAW-HLTDEBUG/MCRUN2_73_V7-v1/00000/A609D6D3-E985-E411-88BD-02163E00E63D.root'
        )
)
...
# My EDAnalyzer that creates the menu studies protobuf file
process.load("L1Trigger.MenuGeneration.produceMenuGenerationSample_cfi")
process.analysis_step = cms.Path( process.produceMenuGenerationSample )

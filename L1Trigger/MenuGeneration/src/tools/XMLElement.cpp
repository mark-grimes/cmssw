...
std::string l1menu::tools::XMLElement::getAttribute( const std::string& name ) const
{
	...
	if( pAttribute==nullptr ) throw l1menu::IncorrectFileFormatException( "XMLElement has no attribute named "+name );
...
std::string l1menu::tools::XMLElement::getValue() const
{
	...
	throw l1menu::IncorrectFileFormatException( "XMLElement "+name()+" has no value set." );
}

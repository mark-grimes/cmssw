...
# out, the only important parts are the 3 lines at the end.
#
...
# with command line options: FourMuPt_1_200_cfi --conditions auto:upgrade2019 -n 10 --eventcontent FEVTDEBUG --relval 10000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Gauss --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2019 --geometry Extended2019 --magField 38T_PostLS1 --fileout file:step1.root --no_exec
...
#----------------------------------------------------------------------------
process.dumpDetIdInfo = cms.EDAnalyzer("DumpTrackerDetIdInfo")
process.marksAnalysis_step = cms.Path(process.dumpDetIdInfo)
process.schedule = cms.Schedule(process.marksAnalysis_step)
